...
parser.add_argument('--model_type',default='resnet50',help = 'simply or resnet50')
...
if __name__ == '__main__':
    ...
    config = ChipsConfig()# NUM_TRAIN IS default to be 20000 in config.py
    config.display()
    ...
    WEIGHT_DIR = MODEL_DIR+args.model_weights
